    ...
    <section id="contato" className="py-24 relative bg-offwhite">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="text-[#5A1788] font-semibold tracking-wider uppercase text-sm mb-4 block">
              Fale Conosco
            </span>
            <h2 className="text-3xl md:text-5xl font-bold text-[#5A1788] mb-6">
              Visite nossas lojas
            </h2>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                <div className="mt-1 bg-[#5A1788]/10 p-2 rounded-full text-[#5A1788] h-fit">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-bold text-[#5A1788] text-lg">Unidade 01</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[#5A1788] text-lg">Unidade 02</h4>
                  <p className="text-earth-600 leading-relaxed">
              ...
              <div className="pt-4">
                <a 
                  ...
                  className="inline-flex items-center gap-3 bg-[#5A1788] hover:bg-[#4a1270] text-white px-6 py-3 rounded-xl transition-colors shadow-lg font-medium"
                >
          ...
          >
            <iframe 
              ...
              title="Mapa das Lojas Empórios MDA"
            ></iframe>
          </motion.div>
