...
const slides = [
  {
    ...
    subtitle: 'Sabor autêntico e qualidade premium para suas receitas.',
    highlight: 'Temperos'
  },
  {
    id: 2,
    image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?q=80&w=2121&auto=format&fit=crop',
    title: 'Chás para o corpo e a alma',
    subtitle: 'Bem-estar e equilíbrio em cada xícara.',
    highlight: 'Chás'
  },
  {
    id: 3,
    ...
    subtitle: 'Saúde e pureza direto da natureza para sua mesa.',
    highlight: 'Naturais'
  }
];
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6 drop-shadow-lg">
              ...
              <span className="text-mustard-500 italic">{slides[currentSlide].highlight}</span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-mustard-500 hover:bg-mustard-600 text-olive-900 px-8 py-4 rounded-full text-lg font-medium transition-colors shadow-lg shadow-mustard-500/30"
              >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="#produtos"
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#5A1788] hover:bg-[#4a1270] backdrop-blur-md border border-white/30 text-white px-8 py-4 rounded-full text-lg font-medium transition-colors shadow-lg"
              >
                Ver Produtos
