            ...
            <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center gap-4">
                <div className="relative w-64">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-slate-50 dark:bg-slate-800 border-none rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#5A1788]/40 text-slate-800 dark:text-slate-200 placeholder-slate-400"
