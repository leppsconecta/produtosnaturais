...
export default function Wholesale() {
  ...
  return (
    <section id="atacado" className="py-24 bg-[#5A178A] text-offwhite relative overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#99CC33 1px, transparent 1px)', backgroundSize: '30px 30px' }}></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            <span className="text-mustard-500 font-semibold tracking-wider uppercase text-sm mb-4 block">
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#99CC33] backdrop-blur-sm border border-white/20 p-4 md:p-8 rounded-2xl text-center hover:bg-[#88b82d] transition-colors shadow-lg"
              >
                <div className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 rounded-full bg-white text-[#5A178A] mb-4 md:mb-6 shadow-sm">
        ...
        <div className="text-center">
          <motion.a
            ...
            className="inline-flex items-center justify-center gap-2 bg-mustard-500 hover:bg-mustard-600 text-olive-900 px-8 py-4 rounded-full text-lg font-medium transition-colors shadow-lg shadow-mustard-500/20"
          >
