...
>>>>>>> 47ad34f4e89d90b2c4542364948ec5a39214d924
                                                    <div className="relative group w-full">
                                                        ...
                                                        />
                                                        <div className={`px-4 py-3 border-2 border-dashed rounded-xl flex items-center justify-center gap-2 transition-colors ${fileName ? 'border-[#8cc63f] bg-green-50' : 'border-gray-300 bg-gray-50 group-hover:bg-gray-100 group-hover:border-gray-400'}`}>
                                                            <Upload className={`w-4 h-4 flex-shrink-0 ${fileName ? 'text-[#8cc63f]' : 'text-gray-400'}`} />
                                                            <span className={`text-sm font-medium truncate ${fileName ? 'text-[#8cc63f]' : 'text-gray-500'}`}>
